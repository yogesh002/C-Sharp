...
namespace CRUD {
    ...
    public partial class TestDBDataSet : global::System.Data.DataSet {
        ...
        public partial class testDataTable : global::System.Data.TypedTableBase<testRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public testRow AddtestRow(string name, string phone, string email, string address, byte[] image) {
        ...
        public partial class testRow : global::System.Data.DataRow {
            ...
            public string phone {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'phone\' in table \'test\' is DBNull.", e);
                    }
                }
                set {
            ...
            public byte[] image {
                get {
                    try {
                        return ((byte[])(this[this.tabletest.imageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'image\' in table \'test\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletest.imageColumn] = value;
                }
            }
            ...
            public bool IsimageNull() {
                return this.IsNull(this.tabletest.imageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetimageNull() {
                this[this.tabletest.imageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CRUD.TestDBDataSetTableAdapters {
    ...
    public partial class testTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `test` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` =" +
                " ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `email` " +
                "IS NULL) OR (`email` = ?)) AND ((? = 1 AND `address` IS NULL) OR (`address` = ?)" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `test` (`name`, `phone`, `email`, `address`, `image`) VALUES (?, ?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `test` SET `name` = ?, `phone` = ?, `email` = ?, `address` = ?, `image` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `address` IS NULL) OR (`address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD.Properties.Settings.Default.TestDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, phone, email, address, [image] FROM test";
        ...
        public virtual int Fill(TestDBDataSet.testDataTable dataTable) {
        ...
        public virtual TestDBDataSet.testDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDBDataSet.testDataTable dataTable = new TestDBDataSet.testDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDBDataSet.testDataTable dataTable) {
        ...
        public virtual int Insert(string name, string phone, string email, string address, byte[] image) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string phone, string email, string address, byte[] image, int Original_ID, string Original_name, string Original_phone, string Original_email, string Original_address) {
            if ((name == null)) {
